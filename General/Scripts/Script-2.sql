...
-- 계정 생성
CREATE USER SPRING_KDH IDENTIFIED BY SPRING1234;

-- 권한 부여
GRANT CONNECT, RESOURCE TO SPRING_KDH;

-- 테이블 저장 공간 할당
ALTER USER SPRING_KDH
...
UPDATE "MEMBER"
SET
	"MEMBER_PW" = '$2a$10$GkGLJeAcEzCI0SID8D70quQ16VVbPlqwJyNDu4gHKaDSoIbPbssOq'
WHERE
	"MEMBER_NO" = 1;
